...
{
    public class InvoiceRepositoryTests : IClassFixture<MongoDbFixture>
    {
        private readonly InvoiceRepository _repository;

        public InvoiceRepositoryTests(MongoDbFixture mongoDbFixture)
        {
            _repository = mongoDbFixture.Repository;
        }
